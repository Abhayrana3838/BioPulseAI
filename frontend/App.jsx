...
import FleetLogisticsSmooth from './FleetLogisticsSmooth.jsx'
...
import PremiumSecurityDashboard from './PremiumSecurityDashboard.jsx'
// import SecurityOperationsDashboard from './SecurityOperationsDashboardSimple.jsx'
...
function App() {
  ...
  const views = [
    { id: 'fleet', name: 'FLEET LOGISTICS', component: FleetLogisticsSmooth },
    ...
    { id: 'security', name: 'SECURITY OPS', component: PremiumSecurityDashboard },
  ]
  ...
  return (
    <div style={{ width: '100vw', height: '100vh', background: '#03050A', position: 'relative' }}>
      ...
      {/* Footer */}
      <footer style={{
        position: 'fixed', bottom: 0, left: 0, right: 0, height: 32, zIndex: 50,
        ...
        <span style={{ fontFamily: "'Syne', sans-serif", fontSize: 8, fontWeight: 700, letterSpacing: '0.2em', color: '#5A7090' }}>
          © 2026 BIOPULSE ELITE // ALL SYSTEMS OPERATIONAL
        </span>
